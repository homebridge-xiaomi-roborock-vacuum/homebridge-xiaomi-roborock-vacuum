...
module.exports = {
  ...
  "gen1+custom": [
    ...
    { homekitTopLevel: 0, miLevel: 200, name: "Off" },
    // 1-25%   = "Light"
    { homekitTopLevel: 25, miLevel: 201, name: "Light" },
    // 26-50%  = "Medium"
    { homekitTopLevel: 50, miLevel: 202, name: "Medium" },
    // 51-75% = "High"
    { homekitTopLevel: 75, miLevel: 203, name: "Hight" },
    // 76-100% = "Custom"
    { homekitTopLevel: 100, miLevel: 204, name: "Custom" },
  ],
};
